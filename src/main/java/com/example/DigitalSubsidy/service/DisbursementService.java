    ...
    public Disbursement createDisbursement(
        ...
        RegionalAllocation allocation =
                regionalAllocationRepo
                        ...
                        .findFirst()
                        .orElseGet(() -> {
                            RegionalAllocation autoAlloc = new RegionalAllocation();
                            autoAlloc.setScheme(application.getScheme());
                            autoAlloc.setRegion(region);
                            autoAlloc.setAllocatedBudget(50000000.0);
                            autoAlloc.setUsedBudget(0.0);
                            return regionalAllocationRepo.save(autoAlloc);
                        });
