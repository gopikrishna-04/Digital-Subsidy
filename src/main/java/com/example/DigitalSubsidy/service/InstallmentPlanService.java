...
public class InstallmentPlanService {
    ...
    public synchronized void createInstallmentPlan(
            Application application,
            Double totalGrant) {

        if (application == null || application.getId() == null || totalGrant == null || totalGrant <= 0) {
            return;
        }

        // Prevent duplicate plan
        List<InstallmentPlan> existing =
                installmentPlanRepo.findByApplicationId(application.getId());
        ...
        // ================= INSTALLMENT 1 =================
        InstallmentPlan installment1 = new InstallmentPlan();
        ...
        // ================= INSTALLMENT 2 =================
        InstallmentPlan installment2 = new InstallmentPlan();
        ...
        // ================= INSTALLMENT 3 =================
        InstallmentPlan installment3 = new InstallmentPlan();
        ...
        installmentPlanRepo.saveAllAndFlush(List.of(installment1, installment2, installment3));
    }
}